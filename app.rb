...
get '/incoming_sms' do
  ...
  if body.include? "stop"
    ...
    message = "We recommend 4-15 days depending on the food. Type a number to set the timer."
  elsif body_toint < 4
    ...
    message = "Sorry, I did not get that. Enter a value 1-30 or place me in the fridge."
  end
